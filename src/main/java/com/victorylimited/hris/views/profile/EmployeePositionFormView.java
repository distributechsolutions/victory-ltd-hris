...
public class EmployeePositionFormView extends VerticalLayout implements HasUrlParameter<String> {
    ...
    private void buildEmployeePositionFormLayout() {
        ...
        activePositionCheckbox = new Checkbox("Is Position Active?");
        if (employeePositionDTO != null) activePositionCheckbox.setValue(employeePositionDTO.isActivePosition());
        ...
        employeePositionDTOFormLayout.add(employeeDTOComboBox,
                ...
                buttonLayout);
        employeePositionDTOFormLayout.setColspan(activePositionCheckbox, 2);
    ...
    private void saveOrUpdateEmployeePositionDTO() {
        ...
        employeePositionDTO.setActivePosition(activePositionCheckbox.getValue());
